...
public class StatsController {
    ...
    public Result<Map<String, Object>> getPurchasePlan(@RequestParam String month) {
        ...
        QueryWrapper<PurchasePlan> planQuery =
                new QueryWrapper<>();
        planQuery.eq("month", month);
        PurchasePlan plan = purchasePlanMapper.selectOne(planQuery);
        ...
        QueryWrapper<PurchasePlanDetail> detailQuery =
                new QueryWrapper<>();
        detailQuery.eq("plan_id", plan.getId());
        List<PurchasePlanDetail> details = purchasePlanDetailMapper.selectList(detailQuery);
    ...
    public void exportMonthlySummary(@RequestParam String month, HttpServletResponse response) throws IOException {
        ...
        for (Map<String, Object> map : excelList) {
            ...
            if (map.containsKey("leaderMedicineAmount")) {
                ...
                vo.setMissingInventoryMonths(formatList(map.get("missingInventoryMonths")));
                vo.setIsLastYearStockMissing(formatBool(map.get("isLastYearStockMissing")));
                vo.setIsYearEndStockMissing(formatBool(map.get("isYearEndStockMissing")));
            }
            rows.add(vo);
        }
    ...
    public void exportPurchasePlan(@RequestParam String month, HttpServletResponse response) throws IOException {
        ...
        for (PurchasePlanDetail d : details) {
    ...
    private String formatBool(Object obj) {
